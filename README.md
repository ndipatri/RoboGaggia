...
('coffee robot' image compliments of my artistic friend, https://www.linkedin.com/in/mikeballz/)
...
You might have noticed in my [Video of RoboGaggia](https://youtu.be/7mQ_3sYM7KM), that I use a strange [Weiss Distribution Technique](https://www.baristahustle.com/weiss-distribution-technique/) device.  This is something I built myself using [these instructions](https://roastandrevel.de/blogs/news/open-sourcing-our-wdt-tool-with-ball-bearings).  It uses sealed bearings, machine screws, accupuncture needles, and some [3D printed parts](https://www.thingiverse.com/thing:6449968).
